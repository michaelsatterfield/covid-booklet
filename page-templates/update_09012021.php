...
<div class="main-wrapper">
        ...
        <div class="header-top__wrapper">
            ...
            <nav class="nav-main">
                <ul class="nav-main__list">
                    <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="200">[Be a catalyst.]</a>
                    </li>
                    <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="700">[Make an
                            impact.]</a></li>
                    <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="1765">[Embrace
                            change.]</a></li>
                    <li class="nav-main__item"><a class="nav-main__link" href="#" data-offset="2565">[Have courage]</a>
                    </li>
    ...
    <div class="header-left">
        <div class="header-left__wrapper">
            ...
            <button
                    class="button button-mobile-menu button-mobile-menu-header-left" data-toggle=".header-left-nav">
...
<!--            <div class="section-1__text-2">we rely on relationships.</div>-->
    ...
    <section class="section-2">
        <div class="section-2__text">
            <div class="section-2__text-1"></div>
            <div class="section-2__text-2"></div>
            <div class="section-2__text-3"></div>
            <div class="section-2__text-4">
        <span>
            <div class="section-2__text-1">The coronavirus pandemic</div>
        </span>
                prompted all of us to act quickly, depend on each other, and encourage innovation. We have prioritized
                community-led solutions,
                trusting those on the front lines to do the work they know how to get done, to serve their neighbors who
                are in need.
            </div>
    ...
    <section class="section-11">
        ...
        <div class="section-11__text">
            We are proud to have been the bridge between those most able to give and those who most needed to receive.
            With community input, research and strategic planning, the San Antonio Area Foundation focused grantmaking
            and relief efforts on <span>four Impact Areas.</span>
        </div>
    ...
    <section class="section-13a">
        <div class="section-13a__text">
            ...
            <br>
            <br>
            <p>Recognizing the challenges rooted in inequitable systems, and identifying the need to uplift the
                ...
                food distribution, household and hygiene kits, financial assistance, and accessing healthcare. </p>
        </div>
        ...
        <div class="section-23a__text-wrapper">
            <div class="section-23a__text">
                <h3>HOW DO YOU BRING ABOUT JUSTICE AND EQUITY WHILE STRENGTHENING BONDS BETWEEN DIVERSE COMMUNITIES OF
                    COLOR?</h3>
                <br>
                <p>The San Antonio Equity Fellowship Program is a pilot transformational leadership program focused on
                    bringing together African American and Latinx participants who are committed to constructively
                    altering societal conditions toward fuller justice and equity for all. The San Antonio Area
                    Foundation is pleased to offer this unique opportunity for personal and professional development as
                    ...
                    to call upon each other in the future.</p>
            </div>
